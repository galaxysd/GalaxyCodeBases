...
=pod
$flag:
	0000: 0, Other         pos not match
	0001: 1, Shifted       pos not match
	0011: 3, 1sideOK       softclip wrong
	0111: 7, HasTailTrim   softclip wrong
	1111: 15,Perfect       Perfect
=cut
}
close $bamfh;
...
# bamstat.pl:171: {
#   "0000000000000000" => 93,	*Other,Other
#   "0000000000001111" => 18,	Fq1 pefect match
#   "0000000000010000" => 4,	*Other,Shifted
#   "0000000000010001" => 253,	*Shifted,Shifted
#   "0000000000010011" => 29,	fq1 partily match
#   "0000000000010111" => 136,	fq1 partily match
#   "0000000000011111" => 242,	Fq1 pefect match
#   "0000000000111111" => 169,	Fq1 pefect match
#   "0000000001110000" => 1,	fq2 partily match
#   "0000000001111111" => 796,	Fq1 pefect match
#   "0000000011110000" => 26,	Fq2 pefect match
#   "0000000011110001" => 13,	Fq2 pefect match
#   "0000000011110011" => 161,	Fq2 pefect match
#   "0000000011110111" => 922,	Fq2 pefect match
#   "0000000011111111" => 2182,	PEallpefectmatch
