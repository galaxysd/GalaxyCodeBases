...
static char **rdname;
static int *map_score,*hit_frdex,*hit_refst,*hit_refed,*hit_rcdex,*hit_quest,*hit_queed;
...
//     char **rdname;
     ...
     float rate1 = 1.0+insert_std;
     float rate2 = 1.0-insert_std; 
     int insertSize1 = rate1*insert_size;
     int insertSize2 = rate2*insert_size;
