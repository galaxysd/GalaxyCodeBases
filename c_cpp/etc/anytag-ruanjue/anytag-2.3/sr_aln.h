...
extern "C" {
	...
	SR_AlnAux* sr_init_aux(uint32_t strand, uint32_t  min_overlap, uint32_t max_mismatch, float min_similarity, int allow_gap, int filter_dup, uint32_t max_hits_per_query);
