...
int usage(){
	printf(
			...
			"Options: \n"
			"#global\n"
			" -g <int>    Genome size (bp),  REQUIRED *\n"
			" -t <int>    Number of threads [8]*\n"
			" -X <int>    Min insert-size library to be selected as AR [all except smallest]\n"
			...
			"             slow the realign, MUST be bigger than 0 [1000]\n"
			...
			"\n"
			"Example1: \n"
			"$> anytag -g 6000000 -t 32 -r 80 my_test1\\ \n"
			...
			"Example2: \n"
			"$> anytag -g 4000000000 -x 150 -y 300 -r 100 -1 -l 50 -a -3 -C 0 joint_reads joint.ins200.var70.s1.fq.gz joint.ins200.var70.s2.fq.gz\n"
			"# join reads, -a is enabled\n"
			"Example3:\n"
			"$> anytag -g 3000000000 -t 32 -x 500 -y 700  -r 100 human_ps human_data.*\n"
			"Example4:\n"
			"$> anytag -g 3000000000 -t 32 -1 -n 2 -s 1 -m 0 het het.*.fq\n"
