...
typedef struct {
	uint32_t rid;
	uint32_t off:17, len:10, dir:1, mm:4;
} Supp;

define_list(suppv, Supp);
...
extern "C" {
	...
	// STEP 6: output
	void output_lgraph(LGraph *g, FILE *seqf, FILE *cnsf);
