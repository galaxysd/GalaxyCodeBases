...
aux1 = sr_init_aux(1, MAX_RD_LEN, mall->opt->min_ol[0], mall->opt->max_mm[0], mall->opt->min_sm[0], mall->opt->allow_gap[0], 0, mall->opt->max_hits[0] / sdb->n_part);
aux2 = sr_init_aux(1, MAX_RD_LEN, mall->opt->min_ol[0], mall->opt->max_mm[0], mall->opt->min_sm[0], mall->opt->allow_gap[0], 0, mall->opt->max_hits[0] / sdb->n_part);
