...
// Static functions
static void QSufSortSortSplit(long long* __restrict V, long long* __restrict I, const long long lowestPos, 
							  const long long highestPos, const long long numSortedChar);
static long long QSufSortChoosePivot(long long* __restrict V, long long* __restrict I, const long long lowestPos, 
							   const long long highestPos, const long long numSortedChar);
static void QSufSortInsertSortSplit(long long* __restrict V, long long* __restrict I, const long long lowestPos, 
									const long long highestPos, const long long numSortedChar);
static void QSufSortBucketSort(long long* __restrict V, long long* __restrict I, const long long numChar, const long long alphabetSize);
static long long QSufSortTransform(long long* __restrict V, long long* __restrict I, const long long numChar, const long long largestInputSymbol, 
							 const long long smallestInputSymbol, const long long maxNewAlphabetSize, long long *numSymbolAggregated);
...
void QSufSortSuffixSort(long long * __restrict V, long long* __restrict I, const long long numChar, const long long largestInputSymbol, 
						const long long smallestInputSymbol, const int skipTransform) {

	long long i, j;
	long long s, negatedSortedGroupLength;
	long long numSymbolAggregated;
	long long maxNumInputSymbol;
	long long numSortedPos = 1;
	long long newAlphabetSize;
	...
	while ((long long)(I[0]) >= -(long long)numChar) {
		i = 0;
...
void QSufSortGenerateSaFromInverse(const long long* V, long long* __restrict I, const long long numChar) {
...
static void QSufSortInsertSortSplit(long long* __restrict V, long long* __restrict I, const long long lowestPos, 
	...
	long long i, j;
	long long tmpKey, tmpPos;
	long long numItem;
	long long key[INSERT_SORT_NUM_ITEM], pos[INSERT_SORT_NUM_ITEM];
	long long negativeSortedLength;
	long long groupNum;
...
static long long QSufSortTransform(long long* __restrict V, long long* __restrict I, const long long numChar, const long long largestInputSymbol, 
	...
	long long c, i, j;
	long long a;	// numSymbolAggregated
	long long mask;
	long long minSymbolInChunk = 0, maxSymbolInChunk = 0;
	long long newAlphabetSize;
	long long maxNumInputSymbol, maxNumBit, maxSymbol;

	maxNumInputSymbol = largestInputSymbol - smallestInputSymbol + 1;

	for (maxNumBit = 0, i = maxNumInputSymbol; i; i >>= 1) ++maxNumBit;
	maxSymbol = INT64_MAX >> maxNumBit;
