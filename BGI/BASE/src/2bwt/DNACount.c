...
unsigned long long ForwardDNAOccCount(const unsigned int*  dna, const unsigned long long index, const unsigned int character, const unsigned long long*  dnaDecodeTable) {
    ...
    unsigned long long wordToCount, charToCount;
...
unsigned long long Forward1OccCount(const unsigned int*  bitVector, const unsigned long long index, const unsigned long long*  dnaDecodeTable) {
    ...
    unsigned long long wordToCount, bitToCount;
    unsigned long long i, c;
    unsigned long long sum = 0;
    unsigned long long numberOf1;
...
unsigned long long Backward1OccCount(const unsigned int*  bitVector, const unsigned long long index, const unsigned long long*  dnaDecodeTable) {
...
void ForwardDNAAllOccCountNoLimit(const unsigned int*  dna, const unsigned long long index, unsigned long long* __restrict occCount, const unsigned long long*  dnaDecodeTable) {
    ...
    iteration = index / 16;
    wordToCount = (index - iteration * 16) / 8;
    charToCount = index - iteration * 16 - wordToCount * 8;
    ...
    if (charToCount > 0) {
        ...
        sum += dnaDecodeTable[c >> 16];
        sum += dnaDecodeTable[c & 0xFFFF];
        occCount[0] += charToCount - 16;    // decrease count of 'a' by 16 - positionToProcess
    }

    for (j=0;j<DNA_ALPHABET_SIZE;j++) {
        occCount[j] += sum & 0x0000000F;    sum >>= 4;
    }
}
...
unsigned long long ForwardDNA_NOccCountNoLimit(const unsigned int*  dna, const unsigned long long index, const unsigned int character, const unsigned long long*  dnaDecodeTable) {
...
unsigned long long ForwardOccCount(const unsigned int*  packed, const unsigned long long index, const unsigned int character, const unsigned int alphabetSize) {
    ...
    unsigned long long wordToCount, charToCount;
    unsigned long long bitPerChar, charPerWord;
    unsigned long long i, j, c;
    unsigned long long occCount = 0;
...
void ForwardAllOccCount(const unsigned int*  packed, const unsigned long long index, const unsigned int alphabetSize, unsigned int*  occCount) {
...
void BackwardAllOccCount(const unsigned int*  packed, const unsigned long long index, const unsigned int alphabetSize, unsigned int*  occCount) {
