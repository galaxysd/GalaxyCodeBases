...
rm -vR '/Library/Internet Plug-Ins'/*SharePoint*
rm -vR '/Library/LaunchDaemons/'*microsoft*
rm -vR '/Library/Preferences/'*microsoft*
rm -vR '/Library/PrivilegedHelperTools/'*microsoft*
