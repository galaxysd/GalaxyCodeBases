...
tabAll <- fread(paste0("gzip -dc ",InVCFgz,"|grep -ve '^#' |head -n500000000"),header=F,stringsAsFactors=T,sep="\t",autostart=100,select=c(1,2), colClasses=classes, data.table=T,verbose=F)
