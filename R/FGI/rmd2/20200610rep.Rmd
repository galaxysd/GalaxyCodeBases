...
```{r fpGT, out.width='100%', fig.align='center', fig.cap='个人基因型Circos图'}
imgFile <- file.path('dat',paste0(SampleID,'_report.png'))
...
```{r fSNPdist, out.width='80%', fig.align='center', fig.cap=''}
